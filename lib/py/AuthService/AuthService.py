...
class Iface(object):
    ...
    def exchangeKey(self, authSessionId, request):
        """
        Parameters:
         - authSessionId
         - request
    ...
    def setClovaCredential(self, authSessionId, request):
        """
        Parameters:
         - authSessionId
         - request
    ...
    def setPassword(self, authSessionId, request):
        """
        Parameters:
         - authSessionId
         - request
...
class Client(Iface):
    ...
    def exchangeKey(self, authSessionId, request):
        ...
        """
        self.send_exchangeKey(authSessionId, request)
        return self.recv_exchangeKey()

    def send_exchangeKey(self, authSessionId, request):
        self._oprot.writeMessageBegin('exchangeKey', TMessageType.CALL, self._seqid)
    ...
    def recv_exchangeKey(self):
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "exchangeKey failed: unknown result")
    ...
    def respondE2EELoginRequest(self, verifier, publicKey, encryptedKeyChain, hashKeyChain, errorCode):
        ...
        return self.recv_respondE2EELoginRequest()
    ...
    def recv_respondE2EELoginRequest(self):
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "respondE2EELoginRequest failed: unknown result")
    ...
    def setClovaCredential(self, authSessionId, request):
        ...
        """
        self.send_setClovaCredential(authSessionId, request)
        return self.recv_setClovaCredential()

    def send_setClovaCredential(self, authSessionId, request):
        self._oprot.writeMessageBegin('setClovaCredential', TMessageType.CALL, self._seqid)
    ...
    def recv_setClovaCredential(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "setClovaCredential failed: unknown result")
    ...
    def setPassword(self, authSessionId, request):
        ...
        """
        self.send_setPassword(authSessionId, request)
        return self.recv_setPassword()

    def send_setPassword(self, authSessionId, request):
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["exchangeKey"] = Processor.process_exchangeKey
        ...
        self._processMap["setClovaCredential"] = Processor.process_setClovaCredential
    ...
    def process_exchangeKey(self, seqid, iprot, oprot):
        args = exchangeKey_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = exchangeKey_result()
        try:
            result.success = self._handler.exchangeKey(args.authSessionId, args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("exchangeKey", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_respondE2EELoginRequest(self, seqid, iprot, oprot):
        ...
        result = respondE2EELoginRequest_result()
        try:
            result.success = self._handler.respondE2EELoginRequest(args.verifier, args.publicKey, args.encryptedKeyChain, args.hashKeyChain, args.errorCode)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
    ...
    def process_setClovaCredential(self, seqid, iprot, oprot):
        args = setClovaCredential_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = setClovaCredential_result()
        try:
            result.success = self._handler.setClovaCredential(args.authSessionId, args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("setClovaCredential", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_setPassword(self, seqid, iprot, oprot):
        ...
        result = setPassword_result()
        try:
            result.success = self._handler.setPassword(args.authSessionId, args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
...
class exchangeKey_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(exchangeKey_args)
exchangeKey_args.thrift_spec = (
    None,  # 0
    None,  # 1
    (2, TType.STRING, 'authSessionId', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'request', [AuthKeyExchangeRequest, None], None, ),  # 3
)
...
class exchangeKey_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(exchangeKey_result)
exchangeKey_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [AuthKeyExchangeResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [TalkException, None], None, ),  # 1
)
...
class setClovaCredential_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setClovaCredential_args)
setClovaCredential_args.thrift_spec = (
    None,  # 0
    None,  # 1
    (2, TType.STRING, 'authSessionId', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'request', [AuthLoginRequest, None], None, ),  # 3
)
...
class setClovaCredential_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setClovaCredential_result)
setClovaCredential_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [AuthLoginResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [TalkException, None], None, ),  # 1
)
